...
print(count_word(speech,"Russia"))
print(count_word(speech, "Ukraine"))
print(count_word(speech, "Thank you"))
print(count_word(speech, "Freedom"))

print(locate_all(speech, "And we did"))
